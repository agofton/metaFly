...
# set params and help
hmessage="Runs a series of usearch 9.2 scripts to filter out taxa specified in -t {tax_list} - a user generated list of genera to exclude. Writes filtered .fasta files to -o {output dir}"
usage="Usage: $(basename "$0") -i {dir with reads} -b6 {dir with stitched .b6out files} -t {user generated taxa_list.txt to filt} -o {output dir} -h [print this message]"
...
echo "Concatenating all reads to filt and making R1 and R2 read list"
echo ""
